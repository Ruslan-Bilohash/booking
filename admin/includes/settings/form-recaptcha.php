...
<form method="post" class="adm-settings-form">
    <div class="adm-card">
        <div class="adm-card-head">
            <h2><i class="fas fa-shield-alt" style="color:var(--adm-accent);margin-right:8px"></i> <?= htmlspecialchars(bk_settings_admin_label('recaptcha_section', $ta)) ?></h2>
        </div>
        <div class="adm-card-body padded">
            <p class="adm-help"><?= htmlspecialchars(bk_settings_admin_label('recaptcha_help', $ta)) ?></p>
            <?php bk_render_admin_steps($ta, 'recaptcha_steps'); ?>
            <div class="adm-form-grid adm-form-grid--settings">
                <div class="adm-field adm-field-check adm-field-full">
                    <label><input type="checkbox" name="recaptcha_enabled" value="1" <?= !empty($settings['recaptcha_enabled']) ? 'checked' : '' ?>> <?= htmlspecialchars(bk_settings_admin_label('recaptcha_enabled', $ta)) ?></label>
                </div>
                <div class="adm-field adm-field-full">
                    <label><?= htmlspecialchars(bk_settings_admin_label('recaptcha_site_key', $ta)) ?></label>
                ...
                <div class="adm-field adm-field-full">
                    <label><?= htmlspecialchars(bk_settings_admin_label('recaptcha_secret_key', $ta)) ?></label>
