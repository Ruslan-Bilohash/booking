...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $result = cms_contact_handle_post($product, $lang, 'https://bilohash.com/booking/contact.php');
...
$cms_recaptcha_site_key = cms_recaptcha_site_key();
...
$cms_prefix = 'bk';
$body_class = 'bk-page-contact';
$cms_action = bk_url('contact.php') . ($lang !== 'no' ? '?lang=' . urlencode($lang) : '');
